...
echo -en "${Green}####################################################### \n"
echo -en "Ubicamos en la Raiz : proyecto : ${NAME_DIR} \n"
echo -en "Power by: Cesar Auris \n"
echo -en "${Green}####################################################### \n"

echo -en "${Blue}\n"

# Almacenar la salida de la búsqueda en una variable
...
function listar_ficheros(){
    ...
    while IFS= read -r archivo || [[ -n "$archivo" ]]; do
        ...
        echo "---------------------------------------------------"
        echo -en "${Cyan}Nombre actual a:: ${archivo}\n"
        echo -en "${Yellow}Sera Renombrado a: ${nuevo_nombre} \n"
    ...
    echo ""
   echo -en "${Blue}encontrados: ${files_count} ${Color_Off}\n"
    echo -en "${Color_Off}\n"
}

function renombrar_ficheros(){
    find . -type f -regex '.*[áéíóúüñ()].*' > "${path_log}"
    ...
    echo ""
    echo -en "${Blue}Modificados: ${files_count} ${Color_Off}\n"
...
mostrar_menu() {
    echo -en  "${Green} \n"
    echo "======= Menú: =========="
    echo "1. Listar ficheros con acentos:."
    echo "2. Listar y renombrar los acentos: ."
    echo "3. Salir"
...
while true; do
    ...
    case $opcion in
        1)
            echo "Listar ficheros con acentos." &&  clear && sleep 2
            listar_ficheros
            ;;
        2)
            echo "Listar y renombrar los acentos ." &&  clear && sleep 2
            renombrar_ficheros
            ;;
        3)
