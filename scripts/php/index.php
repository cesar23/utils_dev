...
function getStartStress()
{
    ...
    try {
//        $command = 'stress-ng --cpu 4 -v --timeout 180s > /dev/null 2 >/dev/null &'; // solo funcion en consola
        $command = 'stress-ng --cpu 4 -v --timeout 180s';
        exec($command);
        if (!isset($_SESSION['command'])) {
...
<div class="container text-center">
    ...
    <div class="row" style="padding: 7px">
        ...
        <div class="col-4">
            <div class="row" style="padding: 7px">
                <textarea name="cmd" id="cmd" cols="30" rows="10" style="background-color: rgba(26,23,23,0.87); color:#fff; border-radius: 15px; overflow-y: scroll; height:90px;">stress-ng --cpu 4 -v --timeout 180s</textarea>
